...
namespace App\Models {
     ...
     * @property-read \App\Models\ExamTimer $timer
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Exam>|Exam whereDefaultDurationSeconds($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Exam>|Exam whereScheduledAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Exam>|Exam whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Exam>|Exam whereCreatedBy($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<ExamRegistration>|ExamRegistration whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamRegistration>|ExamRegistration whereExamId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamRegistration>|ExamRegistration whereStudentId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamRegistration>|ExamRegistration whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamRegistration>|ExamRegistration whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamRegistration>|ExamRegistration newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ExamRegistration>|ExamRegistration newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ExamRegistration>|ExamRegistration query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class ExamRegistration extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\ExamTimer
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property int|null $updated_by
     * @property int $version
     * @property int $global_adjust_seconds
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\TimerAdjustment> $adjustments
     * @property-read int|null $adjustments_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\TimerAdjustment> $globalAdjustments
     * @property-read int|null $globalAdjustments_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\StudentTimerState> $studentTimerStates
     * @property-read int|null $studentTimerStates_count
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer whereExamId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer whereDurationSeconds($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer whereState($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer whereStartedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer wherePausedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer wherePausedTotalSeconds($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer whereGlobalAdjustSeconds($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer whereVersion($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer whereUpdatedBy($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ExamTimer>|ExamTimer query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class ExamTimer extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\StudentTimerState
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property int|null $updated_by
     * @property integer $version
     * @property integer $student_adjust_seconds
     * @property integer $paused_total_seconds
     * @property \Illuminate\Support\Carbon|null $paused_at
     * @property \Illuminate\Support\Carbon|null $started_at
     * @property mixed $state
     * @property int $student_id
     * @property int $exam_timer_id
     * @property int $id
     * @property-read \App\Models\ExamTimer $examTimer
     * @property-read \App\Models\User $student
     * @property-read \App\Models\User $updatedBy
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState whereExamTimerId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState whereStudentId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState whereState($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState whereStartedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState wherePausedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState wherePausedTotalSeconds($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState whereStudentAdjustSeconds($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState whereVersion($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState whereUpdatedBy($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<StudentTimerState>|StudentTimerState query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class StudentTimerState extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\TimerAdjustment
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<TimerAdjustment>|TimerAdjustment whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TimerAdjustment>|TimerAdjustment whereExamTimerId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TimerAdjustment>|TimerAdjustment whereStudentId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TimerAdjustment>|TimerAdjustment whereSeconds($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TimerAdjustment>|TimerAdjustment whereReason($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TimerAdjustment>|TimerAdjustment whereCreatedBy($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TimerAdjustment>|TimerAdjustment whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TimerAdjustment>|TimerAdjustment whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TimerAdjustment>|TimerAdjustment newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<TimerAdjustment>|TimerAdjustment newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<TimerAdjustment>|TimerAdjustment query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class TimerAdjustment extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property-read int|null $createdExams_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Exam> $examRegistrations
     * @property-read int|null $examRegistrations_count
